...
<?php
    ...
    $reservationQuery = "SELECT r.*, c.*, u.user_id as user_id
    ...
    if ($stmt) {
        ...
        ?>
        <center>
            <form action="viewreservationswithcar.php" method="GET">
            ...
            <!-- Add a back button -->
            <a href="/CarRental/Admin/Frontend/reservationreportcar.html">Back to Main Page</a>
        </center>
        <?php
